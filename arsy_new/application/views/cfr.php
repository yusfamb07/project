...
<body>
  ...
  <img class="icase" src="<?= base_url();?>template_umum/img/Frame.png" alt="">
    <div class="container"> 
      <div class="row">
        <div class="col-6">
          <h1 >Case Fatality<br>Rate</h1>
          <h1 style="font-weight:300;">2021 <img src="<?= base_url();?>template/asset/down2.png" alt=""></h1>
          <div class="dropdown">
            <button  class="btn bg-transparent btn-lg dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              2020
            </button>
