...
<body>
  ...
  <img src="<?= base_url();?>template/asset/tertib.svg" style="width: 25%; position:absolute; right:0; top: 60px;" alt="">

    <div class="container"> 
      <div class="row">
        <div class="col-6">
          <h1>Indeks Ketertiban <br>Nasional</h1>
          <h1 style="font-weight:300;">2020 <img src="<?= base_url();?>template/asset/down2.png" alt=""></h1>
          <p style="margin-top:60px; color:#fff;">Statistik perubahan angka perbandingan jumlah pelanggaran dengan jumlah penduduk atau jumlah kendaraan atau jumlah pengemudi yang menunjukkan makna seberapa besar taraf ketertiban lalu lintas dalam suatu negara.</p>      
        </div>
      </div>
    </div>
